    ...
    if corrections_str == "{}":
        response = client.responses.create(
            ...
            input=(
                ...
                "6. If the doctor says a formatting command in Greek, apply it instead of transcribing it:\n"
                    ...
                    "7. If the doctor says 'διόρθωσε/διόρθωση [X] σε [Y]', apply that correction to the most recent occurrence of X in the text.\n"
                    "8. Keep ALL sentences with medical content. DELETE any sentences or parts of sentences unrelated to medicine (e.g., if the doctor picks up the phone).\n"
                    "9. Do not add any commentary, notes, or explanations. Return only the cleaned transcription.\n\n"
                    "INPUT: " + input + "\nOUTPUT:"
            ))
        ...
        response = client.responses.create(
            ...
            input=(
                    ...
                    "6. Apply the following word corrections throughout the entire output. The keys are wrong words and the values are the correct replacements: " + corrections_str + "\n"
                                                                                                                                                                                       ...
                                                                                                                                                                                       "10. Do not add any commentary, notes, or explanations. Return only the cleaned transcription.\n\n"
                                                                                                                                                                                       "INPUT: " + input + "\nOUTPUT:"
            ))
        if response.output_text:
            return response.output_text
