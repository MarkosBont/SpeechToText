    ...
    if corrections_str == "{}":
        ...
        response = client.responses.create(
            ...
            input=(
                    ...
                    "8. Apply the following word corrections throughout the entire output. The keys are wrong words and the values are the correct replacements: " + corrections_str + "\n"
                                                                                                                                                                                       "9. If the doctor says a formatting command in Greek, apply it instead of transcribing it:\n"
                                                                                                                                                                                       "   - 'παράγραφος' → start a new paragraph\n"
                                                                                                                                                                                       "   - 'τελεία' → insert a period (.)\n"
                                                                                                                                                                                       "   - 'ερωτηματικό' → insert a question mark (;)\n"
                                                                                                                                                                                       "   - 'παύλα' → insert a dash (-)\n"
                                                                                                                                                                                       "   - 'εισαγωγικά' → insert opening quotation marks («)\n"
                                                                                                                                                                                       "   - 'κλείσιμο εισαγωγικών' → insert closing quotation marks (»)\n"
                                                                                                                                                                                       "10. If the doctor says 'διόρθωσε/διόρθωση [X] σε [Y]', apply that correction to the most recent occurrence of X in the text.\n"
                                                                                                                                                                                       "11. Keep ALL sentences with medical content. DELETE any sentences or parts of sentences unrelated to medicine (e.g., if the doctor picks up the phone).\n"
